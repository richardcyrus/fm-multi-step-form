...
export const Route = createFileRoute('/_onboarding/thank-you')({
...
function ThankYouComponent() {
  return (
    <>
      ...
      <div className="inline-flex w-full justify-end bg-transparent p-4 md:pr-17.5 md:pl-10 lg:pr-25 lg:pl-21"></div>
    </>
  )
}
